...
#define UE_PROJECT_NAME OtherworldlyKingdom
#define UE_TARGET_NAME OtherworldlyKingdomEditor
#define UE_MODULE_NAME "DazToUnrealDeveloper"
#define UE_PLUGIN_NAME "DazToUnreal"
