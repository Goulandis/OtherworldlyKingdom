...
#define UE_PROJECT_NAME InsideOpenCV
#define UE_TARGET_NAME InsideOpenCVEditor
#define WITH_OPENCV_BINDING 1
#define UE_MODULE_NAME "GOpenCV"
#define UE_PLUGIN_NAME "GOpenCV"
